...
<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <p>
        <a href="http://172.30.210.147/project/orderonline.php" class="btn btn-warning">Shopping page</a>
        <a href="http://172.30.210.147/project/e1/index" class="btn btn-warning">List data</a>
